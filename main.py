...
def get_user_input():
    ...
    if operation == 'dataset':
        ...
        return 'dataset', dataset, protected_attribute, target_column, output_dir, sample_fraction
        ...
        return 'model', dataset, protected_attribute, target_column, (model, output_dir), sample_fraction
    else:
...
operation, dataset, protected_attribute, target_column, additional_info, sample_fraction = get_user_input()
if dataset is None:
    exit()
...
if operation == 'dataset':
    ...
    best_dataset_path = os.path.join(additional_info, 'best_optimized_dataset.csv')
    ...
    best_model_path = os.path.join(additional_info[1], 'best_model.pkl')
